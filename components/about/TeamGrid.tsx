...
export default function TeamGrid() {
  ...
  const directors: Director[] = [
    ...
    },
    {
      ...
      image: '/new_images/craig_mcnab.jpg',
      shortBio: 'Chartered Accountant and Fellow of the Governance Institute of Australia with 15+ years in the resources industry and accounting across Australia, NZ and the UK. Holds CFO and Company Secretary roles at various ASX-listed companies.',
    },
    {
